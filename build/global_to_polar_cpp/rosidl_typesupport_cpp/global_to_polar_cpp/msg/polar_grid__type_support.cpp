...
static const _PolarGrid_type_support_symbol_names_t _PolarGrid_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, global_to_polar_cpp, msg, PolarGrid)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, global_to_polar_cpp, msg, PolarGrid)),
  }
};
...
{
  return &::global_to_polar_cpp::msg::rosidl_typesupport_cpp::PolarGrid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, global_to_polar_cpp, msg, PolarGrid)() {
  return get_message_type_support_handle<global_to_polar_cpp::msg::PolarGrid>();
}
