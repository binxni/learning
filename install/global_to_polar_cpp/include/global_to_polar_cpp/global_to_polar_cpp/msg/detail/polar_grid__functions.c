...
global_to_polar_cpp__msg__PolarGrid__init(global_to_polar_cpp__msg__PolarGrid * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    global_to_polar_cpp__msg__PolarGrid__fini(msg);
    return false;
  }
  // ranges
...
global_to_polar_cpp__msg__PolarGrid__create()
{
  ...
  global_to_polar_cpp__msg__PolarGrid * msg = (global_to_polar_cpp__msg__PolarGrid *)allocator.allocate(sizeof(global_to_polar_cpp__msg__PolarGrid), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(global_to_polar_cpp__msg__PolarGrid));
  bool success = global_to_polar_cpp__msg__PolarGrid__init(msg);
  if (!success) {
...
global_to_polar_cpp__msg__PolarGrid__Sequence__init(global_to_polar_cpp__msg__PolarGrid__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  global_to_polar_cpp__msg__PolarGrid * data = NULL;

  if (size) {
    data = (global_to_polar_cpp__msg__PolarGrid *)allocator.zero_allocate(size, sizeof(global_to_polar_cpp__msg__PolarGrid), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = global_to_polar_cpp__msg__PolarGrid__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        global_to_polar_cpp__msg__PolarGrid__fini(&data[i - 1]);
      }
...
global_to_polar_cpp__msg__PolarGrid__Sequence__fini(global_to_polar_cpp__msg__PolarGrid__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      global_to_polar_cpp__msg__PolarGrid__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  global_to_polar_cpp__msg__PolarGrid__Sequence * array = (global_to_polar_cpp__msg__PolarGrid__Sequence *)allocator.allocate(sizeof(global_to_polar_cpp__msg__PolarGrid__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = global_to_polar_cpp__msg__PolarGrid__Sequence__init(array, size);
  if (!success) {
...
global_to_polar_cpp__msg__PolarGrid__Sequence__destroy(global_to_polar_cpp__msg__PolarGrid__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    global_to_polar_cpp__msg__PolarGrid__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
global_to_polar_cpp__msg__PolarGrid__Sequence__are_equal(const global_to_polar_cpp__msg__PolarGrid__Sequence * lhs, const global_to_polar_cpp__msg__PolarGrid__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!global_to_polar_cpp__msg__PolarGrid__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  global_to_polar_cpp__msg__PolarGrid__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(global_to_polar_cpp__msg__PolarGrid);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    global_to_polar_cpp__msg__PolarGrid * data =
      (global_to_polar_cpp__msg__PolarGrid *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!global_to_polar_cpp__msg__PolarGrid__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          global_to_polar_cpp__msg__PolarGrid__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!global_to_polar_cpp__msg__PolarGrid__copy(
